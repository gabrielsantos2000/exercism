...
def preparation_time_in_minutes(number_of_layers):
    """Calculate the preparation time in minutes by number of layers.

    :param number_of_layers: int - Number of layers of lasagna
    :return: int - Returns the lasagna preparation time according to the number of layers
...
def elapsed_time_in_minutes(number_of_layers, elapsed_back_time):
    ...
    :param elapsed_back_time: int - elapsed cooking time.

    This function takes two integers representing the number of lasagna layers and the
    time already spent baking and calculates the total elapsed minutes spent cooking the
    lasagna.
    """
    return (number_of_layers * PREPARATION_TIME) + elapsed_back_time
